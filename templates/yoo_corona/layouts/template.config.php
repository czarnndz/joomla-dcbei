...
// set webfonts
if($config->get('load_webfonts')) $config->set('webfonts-class', 'webfonts');

// javascripts
$this->warp->javascripts->addDeclaration('var Warp = Warp || {}; Warp.Settings = '.json_encode(array('bganimation' => $config->get('bganimation'),'background' => $config->get('background'), 'itemColor' => $config->get('itemcolor'))).';');
