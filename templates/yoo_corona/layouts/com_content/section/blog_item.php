...
<div class="item">
	...
	<div class="date">
		<div class="day"><?php echo JHTML::_('date', $this->item->created, JText::_('%d')); ?></div><div class="month"><?php echo JHTML::_('date', $this->item->created, JText::_('%b')); ?></div>
	</div>
	<?php endif; ?>
