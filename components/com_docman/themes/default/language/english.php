<?php
/**
 * @version		$Id: english.php 953 2009-10-14 20:38:38Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
define('_DML_TPL_CATS', "");
define('_DML_TPL_DOCS', "Documents");
define('_DML_TPL_CAT_VIEW', "Inicio");
define('_DML_TPL_MUST_LOGIN', "You must login to submit new documents");
define('_DML_TPL_SUBMIT', "Submit File");
define('_DML_TPL_SEARCH_DOC', "Buscar");
...
define('_DML_TPL_NO_DOCS', "There are no documents in this category");
...
define('_DML_TPL_ORDER_ASCENT', "Ascendant");
define('_DML_TPL_ORDER_DESCENT', "Descendent");
define('_DML_TPL_NO_ITEMS_FOUND', "No items were found");
