<?php
/**
 * @version		$Id: list_item.tpl.php 1355 2010-04-30 14:12:55Z tom $
 * @category	DOCman
 * @package		DOCman15
	...
	switch($item_title_link) :
		...
		case 1 :  // link to download, if download is allowed
			if(isset($this->doc->buttons['download'])) {
	            ?><a href="<?php echo $this->doc->buttons['download']->link;?>" title="<?php echo htmlspecialchars($this->doc->data->dmname)?>">
