<?php
/**
 * @version		$Id: helper.php 1344 2010-04-26 21:30:01Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
class DMInstallHelper
{
    function logo()
    {
        ...
        <table>
            <tr>
                <th><a href='index.php?option=com_docman'><img border="0" alt="DOCman" src="http://static.joomlatools.eu/images/docman/logo/docman15.png?<?php echo DMInstallHelper::getInfo()?>" /></a></th>
            </tr>
        </table><?php
    }
